...
const page = () => {
  return (
    ...
    <p>Obtain your health and safety course certificate, which can be used to apply for your <span className='font-bold'>CSCS Card.</span> <br /> Know more about <Link href="/health-and-safety-awareness" className='text-purple_primary font-bold'>health and safety related courses in construction.</Link></p>
