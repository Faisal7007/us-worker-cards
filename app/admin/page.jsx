  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 text-gray-800 px-4">
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 sm:p-8 w-full max-w-md text-center">
        ...
        {/* Logout Reminder */}
        <div className="mt-6 bg-yellow-100 text-yellow-800 p-3 rounded-lg border border-yellow-300 flex items-center justify-center gap-2">
          <FaSignOutAlt
            onClick={handleLogout}
            className="text-lg cursor-pointer text-yellow-700 hover:text-yellow-600 transition-transform transform hover:scale-110"
          />
