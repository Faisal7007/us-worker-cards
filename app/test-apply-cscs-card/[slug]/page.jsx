...
// import CscsForm from '@/app/components/CourseBookForm'

const page = () => {
    const params = useParams();
    const id = params.slug;
    console.log(id,"id in slug page")
  ...
  return (
    <div className='max-w-[1440px] mx-auto px-4 pt-8'>
      <h1 className='text-[30px] font-bold mb-2 capitalize'>This is Test Page ,Apply For CSCS Card</h1>
