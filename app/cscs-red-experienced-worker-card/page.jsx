...
const Page = () => {
  return (
   ...
   <p className='text-justify media-max-545px:text-[14px]'>Apply for a CSCS Card easily using our <Link href='/apply-cscs-card' className='text-purple_primary font-bold'> online application service.</Link>
    </p>
...
<div className='flex justify-between  items-center  mt-10 media-max-1360px:flex-col media-max-1360px:gap-8'>
  ...
  <div>
    <CardForm titleOne='Red Experienced Worker Card' titleTwo='Easy apply for Experienced Worker Card' cardType="red-experienced"/>
  </div>
</div>
