...
const Page = () => {
  return (
   ...
   <p className='media-max-545px:text-[14px] text-justify'>Apply for a CSCS Card easily using our <Link href='/apply-cscs-card' className='text-purple_primary font-bold '> online application service.</Link>
    </p>
