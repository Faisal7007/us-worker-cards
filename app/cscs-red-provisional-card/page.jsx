...
const Page = () => {
  return (
    ...
    {/* <h1 className='text-[20px] font-bold'>Apply by phone</h1> */}
     ...
     <p className='media-max-545px:text-[14px]'>Call <Link href='/' className='text-purple_primary font-semibold hover:text-black '>00000s</Link> to book by phone. Our lines are open Monday to Saturday, from 9 AM to 7 PM.</p>
