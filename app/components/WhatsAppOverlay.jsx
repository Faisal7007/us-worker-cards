...
export default function WhatsAppOverlay() {
    ...
    return (
        <div className="fixed bottom-4 right-4 z-[1000] bg-white shadow-md border border-gray-200 p-2 rounded-lg max-w-[220px] text-xs">
            <div className="flex flex-col items-start gap-1 relative">
                <p className="font-semibold text-gray-800">Get Consultation</p>
                <a
                ...
                <button
                    className="absolute top-0 right-0 text-black hover:text-gray-700 text-xs"
