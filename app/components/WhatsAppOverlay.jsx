    ...
    return (
        <div className="fixed bottom-6 right-6 z-[1000] bg-white shadow-xl border border-gray-200 p-4 rounded-2xl max-w-[300px]">
            <div className="flex flex-col items-start">
                <p className="text-sm font-semibold text-gray-800 mb-2">Talk to our experts</p>
                <a
                    href="https://wa.me/91783317237?text=Hi%20there!%20I%20need%20help%20with%20Construction%20Card%20Services."
                    target="_blank"
