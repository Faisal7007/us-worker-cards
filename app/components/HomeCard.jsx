...
const HomeCard = ({icon,title,description,button_text,link_to}) => {
  return (
    <div className="shadow-[rgba(0,0,0,0.12)_0px_1px_3px,_rgba(0,0,0,0.24)_0px_1px_2px] rounded-md w-[320px] h-[310px] flex flex-col justify-center items-center px-4   hover:shadow-[rgba(0,0,0,0.16)_0px_3px_6px,_rgba(0,0,0,0.23)_0px_3px_6px] ">
    <div className="flex flex-col items-center">
      ...
      <div className="text-center">
        ...
        <div className={`mb-6 text-[14px] ${description ? 'h-[100px]' : 'h-[0px]'}`}>
        {description}
        </div>
