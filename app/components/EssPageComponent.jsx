...
const EssPageComponent = ({id,title_page,image_path,title_form_one,title_form_two,card_type,validity}) => {
  ...
  return (
    ...
    {/* <h1 className='text-[20px] font-bold'>Apply by phone</h1> */}
     ...
     <p className=' text-justify media-max-470px:text-[14px]' >Call <Link href='/' className='text-purple_primary font-semibold hover:text-black '>000000</Link> to book by phone. Our lines are open Monday to Saturday, from 9 AM to 7 PM.</p>
